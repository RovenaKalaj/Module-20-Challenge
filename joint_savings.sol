...
contract JointSavings {
    ...
    - Two variables of type `address payable` named `accountOne` and `accountTwo`  - OK
    - A variable of type `address public` named `lastToWithdraw` - OK
    - Two variables of type `uint public` named `lastWithdrawAmount` and `contractBalance`. - OK
    */
    // YOUR CODE HERE!
